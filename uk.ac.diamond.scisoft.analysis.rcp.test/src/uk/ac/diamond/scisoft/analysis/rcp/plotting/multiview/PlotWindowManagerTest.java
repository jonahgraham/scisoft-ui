...
public class PlotWindowManagerTest {
	...
	final static String PLOTVIEW_CLASS = "uk.ac.diamond.scisoft.analysis.rcp.views.PlotView";
	...
	public void testPlotManagerCreation2() {
		...
		config1.addAttribute(new MockAttribute("class", PLOTVIEW_CLASS));
		...
		config2.addAttribute(new MockAttribute("class", PLOTVIEW_CLASS));
