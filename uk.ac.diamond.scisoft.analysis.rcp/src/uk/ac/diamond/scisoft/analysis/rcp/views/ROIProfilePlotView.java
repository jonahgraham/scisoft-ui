 ...
 * TODO temporary replicate of PlotView class: make it lighter and not a copy like it is currently (too many dependencies on PlotView to modify it)
 */
public class ROIProfilePlotView extends ViewPart implements IObserver, IObservable, IGuiInfoManager, IUpdateNotificationListener {
