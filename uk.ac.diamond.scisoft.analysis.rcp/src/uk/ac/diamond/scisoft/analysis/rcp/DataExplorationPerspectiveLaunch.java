...
public class DataExplorationPerspectiveLaunch implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			IPerspectiveDescriptor per = reg.findPerspectiveWithId(DataExplorationPerspective.ID);
