 ...
 */
public class CustomProjectActivator extends AbstractUIPlugin {

	/** The plug-in ID */
	public static final String PLUGIN_ID = "uk.ac.diamond.scisoft.customprojects.rcp"; //$NON-NLS-1$

	// The shared instance
	private static CustomProjectActivator plugin;
	/**
	 * The constructor
	 */
	public CustomProjectActivator() {
		plugin = this;
	}
	 ...
	 */
	public static CustomProjectActivator getDefault() {
		return plugin;
	}
