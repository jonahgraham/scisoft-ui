 ...
 */
package uk.ac.diamond.scisoft.pydev.rcp;
...
public class JythonPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		bottomLayout.addView("org.dawb.common.ui.views.e4.headerTableView");

		// Finaly add all the Pydev actions as are required for running stuff
		// etc.
